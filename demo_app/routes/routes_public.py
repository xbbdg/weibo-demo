...
def route_dict():
    ...
    d = {
        ...
        # 更改 route_static 和 index.html
        '/static': route_static,
        # '/static/doge.gif': route_static,
        # '/static/doge1.gif': route_static,
        # '/static/doge2.gif': route_static,
